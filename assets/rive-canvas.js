...
}, 445874:() => void 0 !== navigator.mediaDevices && void 0 !== navigator.mediaDevices.getUserMedia, 445978:() => {
  try {
...
}, 449026:a => window.h.ra(a).J.sampleRate, 449099:a => {
  a = window.h.ra(a);
